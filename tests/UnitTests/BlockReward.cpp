...
namespace
{
  ...
  #define TEST_ALREADY_GENERATED_COINS(alreadyGeneratedCoins, expectedReward)                                  \
    m_blockTooBig = !m_currency.getBlockReward(0,0, currentBlockSize, alreadyGeneratedCoins, 0,                  \
  ...
  protected:
    ...
    virtual void SetUp() override {
      m_blockTooBig = !m_currency.getBlockReward(0, 0, 0, alreadyGeneratedCoins, 0,
    ...
    void do_test(size_t medianBlockSize, size_t currentBlockSize) {
      m_blockTooBig = !m_currency.getBlockReward(0,medianBlockSize, currentBlockSize, alreadyGeneratedCoins, 0,
        m_blockReward, m_emissionChange);
    }
  ...
  protected:
    ...
    virtual void SetUp() override {
      m_blockTooBig = !m_currency.getBlockReward(0,testMedian, 0, alreadyGeneratedCoins, 0,
        m_standardBlockReward, m_emissionChange);
    ...
    void do_test(size_t currentBlockSize) {
      m_blockTooBig = !m_currency.getBlockReward(0,testMedian, currentBlockSize, alreadyGeneratedCoins, 0,
        m_blockReward, m_emissionChange);
    }
  ...
  protected:
    virtual void SetUp() override {
      ...
      m_blockTooBig = !m_currency.getBlockReward(0,testMedian, testBlockSize, 0, 0, blockReward, emissionChange);
    ...
    void do_test(uint64_t alreadyGeneratedCoins, uint64_t fee) {
      m_blockTooBig = !m_currency.getBlockReward(0,testMedian, testBlockSize, alreadyGeneratedCoins, fee,
        m_blockReward, m_emissionChange);
    }
